    ...
    public class BilatuController : Controller
    {
        ...
        public async Task<ActionResult> Book(FormCollection collection)
        {
            try
            {
                ...
                Errenta errent = new Errenta(hasiera_data, amaiera_data, hotel_izena, prezioTotala, erabiltzailea_emaila, txartel_zenbakia, txartel_titularra, txartel_iraunginpena, txartel_cvv);
